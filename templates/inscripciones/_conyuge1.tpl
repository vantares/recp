...
$().ready(function() {
    $("#checkconyuge1").click(function(evento){
       ...
       $("#listapersonaconyuge1").load("/modulos/personas/cargarpersonas.php", {template: 'personas/_listadoresultpersonas.tpl', cedula: $("#conyuge1cedula").val(),
                                                      nombre1: $("#inscrito1nombre1").val(), nombre2: $("#inscrito1nombre2").val(), apellido1: $("#inscrito1apellido1").val(),
                                                      apellido2: $("#inscrito1apellido2").val(), cedula: $("#conyuge1cedula").val(), tipo: 'conyuge1', module: 'inscripciones'
                                                     },
