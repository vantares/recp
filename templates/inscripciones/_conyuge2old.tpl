...
$().ready(function() {
    $("#checkconyuge2").click(function(evento){
       ...
       $("#listapersonaconyuge2").load("cargarpersonas.php", {template: 'inscripciones/_listadoresultpersonas.tpl', cedula: $("#conyuge2cedula").val(),
                                                      nombre1: $("#inscrito2nombre1").val(), nombre2: $("#inscrito2nombre2").val(), apellido1: $("#inscrito2apellido1").val(),
                                                      apellido2: $("#inscrito2apellido2").val(), tipo: 'conyuge2',
                                                     },
    ...
    <tr>
         <td class="tcenter">
            <select name="conyuge2estadocivilanterior" {$disabled}>
                ...
                <option value="divorciado" {if $persona.conyuge2.estadocivil == 'divorciado'}selected{/if}>Divorciado</option>
