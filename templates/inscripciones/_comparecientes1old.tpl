...
$().ready(function() {
    $("#checkcompareciente1").click(function(evento){
       ...
       $("#listapersonacompareciente1").load("cargarpersonas.php", {template: 'inscripciones/_listadoresultpersonas.tpl', cedula: $("#compareciente1cedula").val(),
                                                                    nombre: $("#compareciente1nombre").val(), tipo: 'comparecientes1',
                                                                   },
       function(){
