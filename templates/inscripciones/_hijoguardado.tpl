...
$().ready(function() {
    $("#checkguardado").click(function(evento){
       evento.preventDefault();   
       $("#cargando_reconocido").css("display", "inline");
       $("#guardado").load("cargarreconocido.php", {idtomo: $("#tomo").val(), folio: $("#folio").val(), partida: $("#partida").val(), 
                                                      template: 'inscripciones/_listadoresultguardados.tpl', id: $("#idinscripcion").val(),
...
{/literal}
<form name="addguardado" action="__addguardado.php" method="post" id="addguardado">
<table width="80%">
    <tr>
        <td colspan="4">
    ...
    <tr>  
        <td colspan="4" class="tcenter"><table width="100%" border="0" cellpadding="1" cellspacing="1">
          <tr>
            ...
            <td width="15%">
                <span class="chequear">
                   <a href="#" id="checkguardado">Chequear</a> 
                 </span>
            </td>
...
<div class="filadatos noborde" style="float:right">
 ...
 <div class="limpiar"></div>  
<div id="guardado"></div><!--reconocido-->
</form>
