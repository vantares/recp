...
$().ready(function() {
    $("#inscripcion").validate({
        rules: {
            ...
            fechadefuncion: {
                required: true,
                daterangemin: "#fechanacimiento"
                /*daterangemax: "#fechanacimiento"*/
            },
            fechanacimiento: {
                required: true,
                daterangemax: "#fechadefuncion"
        ...
        messages: {
            ...
            fechadefuncion: {
                ...
                daterangemin:  "La Fecha de defuncion no puede ser menor que la de nacimiento"
            },
            fechanacimiento: {
                required: "Fecha de nacimiento no puede estar vacia",
                daterangemax: "La Fecha de nacimiento no puede ser mayor que la de defuncion"
            ...
            ciudaddefuncion: "La ciudad de la defuncion no puede estar vacia",
