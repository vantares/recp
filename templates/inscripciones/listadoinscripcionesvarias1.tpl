...
function pageselectCallback(page_index, jq,campos){
    ...
    for(var i=page_index*opt[2];i<max_elem;i++)
    {
        ...
        newcontent += '<div class="filadatosli" style="width:27%; text-align:center">' + segundoarreglo[camposarreglo[3]] + segundoarreglo[camposarreglo[4]] + segundoarreglo[camposarreglo[5]] + segundoarreglo[camposarreglo[6]] + '</div>';
        newcontent += '<div class="filadatosli" style="width:20%; text-align:center">' + segundoarreglo[camposarreglo[7]] + '</div>';
        newcontent += '<div class="filadatosli" style="width:15%; text-align:center">' + segundoarreglo[camposarreglo[8]] + '</div>';
        newcontent += '<div class="filadatosli noborde" style="width:12%; text-align:center"><div class="floatleft icons"><a href="/modulos/inscripciones/' + $("#pagina").val() + '?id=' + segundoarreglo[camposarreglo[0]] + '"><img src="/imagenes/iconedit.png" alt="editar" title="editar" width="18" height="18" /></a></div>';
        newcontent += '<div class="floatleft icons"><a href="/modulos/inscripciones/' + $("#pagina").val() + '?id=' + segundoarreglo[camposarreglo[0]] + '&detalle=1"><img src="/imagenes/iconrefresh.png" alt="editar" title="editar" width="18" height="18" /></a></div>';
...
<div id="cajadatos">         
    ...
    <div class="filabusqueda">
     ...
     <div class="filaencabezado">
           ...
           <div  class="filaencabezadoli" style="width:27%; text-align:center">Inscrito</div>
           <div  class="filaencabezadoli" style="width:20%; text-align:center">Tipo</div>    
           <div  class="filaencabezadoli" style="width:15%; text-align:center">Fecha</div>
           <div  class="filaencabezadoli" style="width:12%; text-align:center">Acciones</div> 
           <div class="limpiar"></div>
      </div><!--filaencabezado-->
      ...
      <input  type="hidden"  name="campos" id="campos" value="0,25,22,4,5,6,7,26,24"/>   
</div><!--cajadatos-->