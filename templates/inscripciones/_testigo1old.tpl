...
$().ready(function() {
    $("#checktestigo1").click(function(evento){
       ...
       $("#testigo1").load("cargarpersona.php", {idpersona: document.inscripcion.testigo1cedula.value, template: 'inscripciones/_testigo1.tpl', tipo: 'testigo1' , accion: 'add'}, 
       function(){
    ...
    <tr>
         <td class="tcenter">
            <select name="testigo1estadocivil" {$disabled}>
                ...
                <option value="divorciado" {if $persona.testigo1.estadocivil == 'divorciado'}selected{/if}>Divorciado</option>
