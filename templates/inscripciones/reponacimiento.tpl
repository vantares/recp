...
$().ready(function() {
    ...
    $("#inscripcion").validate({
        rules: {
            ...
            lugarjuzgado: "required",
            fechadictament: "required" 
        },
        messages: {
            ...
            nombrejuzgado: "La nombre del juzgado no puede estar vacio",
            lugarjuzgado: "El lugar del juzgado no puede estar vacio", 
            fechadictament: "La fecha dictamen no puede estar vacia",  
            cedulapadre: {
...
<div id="cajadatos"> 
    <div id="contenidowizard">
       <div class="headerwizardizq">Reposici&oacute;n de nacimiento</div> 
       <div id="opciones">
             <a href="/modulos/inscripciones/addreponacimiento.php">Nueva</a>
       </div><!--opciones-->  
       <div id="opciones">
             <a href="/modulos/inscripciones/listarreponacimientos.php">Listado</a>
       </div><!--opciones-->           
    ...
    <fieldset>
      ...
      <div class="filadatos noborde" style="float:right">
        {if $add == ''}
            ...
            <input  type="hidden"  name="tipoinscripcion" value="Reposicion Nacimiento"/> 
