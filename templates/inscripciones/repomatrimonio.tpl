...
<div id="cajadatos"> 
    ...
    <fieldset id="hijos" class="{if $visiblehijo} visible  {else} oculto {/if}">
        <legend>Hijos</legend>
           ...
           <div>
            ...
            {if $visiblehijo}{include file="inscripciones/_listadoreconocidos.tpl"}{/if}           
    </fieldset> 
    {/if} 
     <br />        
    ...
    <fieldset>
        <legend>Oficiado</legend>
        <table width="100%">
            <tr>
                <td class="tcenter"><input type="text" name="oficiojueznotario" value="{$repomatrimonio->request.oficiojueznotario}" {$disabled}/></td>
                <td class="tcenter"><input type="text" name="oficiomunicipio" value="{$repomatrimonio->request.oficiomunicipio}"  {$disabled}/></td>
                <td class="tcenter"><input type="text" name="oficiodepartamento" value="{$repomatrimonio->request.oficiodepartamento}"  {$disabled}/></td>
                <td class="tcenter"><input type="text" id="oficiofecha" name="oficiofecha" value="{$repomatrimonio->request.oficiofecha}" {$disabled}></td>
            </tr>
            <tr>
                <td class="tcenter">Nombre del Juez o Notario</td>
                <td class="tcenter">En el municipio de </td>
                <td class="tcenter">Departamento de </td>
                <td class="tcenter">Fecha</td>
            </tr>
        </table>
    </fieldset>
