...
$().ready(function() {
    $("#checkfallecido").click(function(evento){
       ...
       $("#listapersonafallecido").load("/modulos/personas/cargarpersonas.php", {template: 'personas/_listadoresultpersonas.tpl', nombre: $("#inscrito1nombre").val(), 
                                                                                      cedula: $("#cedulafallecido").val(), tipo: 'fallecido', module: 'inscripciones'
                                                                   },
       function(){
...
/*$().ready(function() {
    $("#checkfallecido").click(function(evento){
       evento.preventDefault();   
       $("#cargando5").css("display", "inline");
       $("#fallecido").load("/modulos/personas/cargarpersona.php", {idpersona: document.inscripcion.cedulafallecido.value, template: 'inscripciones/_fallecido.tpl', tipo: 'fallecido' , accion: 'add', inscrito: 1}, 
       function(){
            $("#cargando5").css("display", "none"); 
       });
    }); 
...
<table width="100%">
    ...
    <tr>  
        <td colspan="4" class="tcenter"><table width="100%" border="0" cellpadding="1" cellspacing="1">
          <tr>
            <td width="25%"><input type="text" id="cedulafallecido" name="cedulafallecido" value="{$persona.fallecido.cedula}" {$disabled}>
		</td>
    ...
    <tr>
        <td colspan="4"><div id="listapersonafallecido"></div><!--listapersona--></td>
    </tr>     
</table>
