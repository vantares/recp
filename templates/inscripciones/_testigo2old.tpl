...
$().ready(function() {
    $("#checktestigo2").click(function(evento){
       ...
       $("#testigo2").load("cargarpersona.php", {idpersona: document.inscripcion.testigo2cedula.value, template: 'inscripciones/_testigo2.tpl', tipo: 'testigo2' , accion: 'add'}, 
       function(){
    ...
    <tr>
         <td class="tcenter">
            <select name="testigo2estadocivil" {$disabled}>
                ...
                <option value="divorciado" {if $persona.testigo2.estadocivil == 'divorciado'}selected{/if}>Divorciado</option>
