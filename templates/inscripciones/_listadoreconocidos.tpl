            ...
            <div class="filadatos">
                ...
                <div class="filadatosli noborde" style="width:15%; text-align:center" >
                   <div  class="floatleft icons">  
                      <a class="class2" href="{'/modulos/inscripciones/__deletereconocido.php'|cat:'/'|cat:$reconocidosbd[id]->request.idreconocimiento|cat:'/'|cat:$reconocidosbd[id]->request.idinscripcion}"><img src="/imagenes/iconcancelar1.png" alt="delete" title="delete" width="18" height="18" /></a>
                   </div>  
                   <div class="limpiar"></div>  
                </div>                
                <div class="limpiar"></div>
