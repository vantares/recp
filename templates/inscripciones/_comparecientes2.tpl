...
$().ready(function() {
    $("#checkcompareciente2").click(function(evento){
       ...
       $("#listapersonacompareciente2").load("/modulos/personas/cargarpersonas.php", {template: 'personas/_listadoresultpersonas.tpl', cedula: $("#compareciente2cedula").val(),
                                                                    nombre: $("#compareciente2nombre").val(), tipo: 'comparecientes2', module: 'inscripciones'
                                                                   },
       function(){
...
<table width="80%"> 
    ...
    <tr>
        <td colspan="4" style="padding-left:10px;"><input type="text" name="compareciente2nombre" id="compareciente2nombre" value="{$persona.comparecientes2.nombre}" size=60 {$disabled}/></td>
    </tr>
    <tr>
