...
<div  class="filaencabezadoli" style="width:7%; text-align:center">Tipo</div>
<div  class="filaencabezadoli" style="width:7%; text-align:center">Fecha</div>   
<div  class="filaencabezadoli" style="width:15%; text-align:center">Entraga</div>
<div  class="filaencabezadoli" style="width:15%; text-align:center">Estado</div>
<div  class="filaencabezadoli" style="width:20%; text-align:center">Solicitante</div> 
