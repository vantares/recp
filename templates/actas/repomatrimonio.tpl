...
<title>Inscripcion de Reposicion de Matrimonio</title>
</head>
<body>
<table width="803" border="0" style="font-size:12px; font-family:Verdana">
    ...
    <td colspan="3" valign="top"><table width="100%" border="0">
      ...
      <tr>
        <td colspan="3" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="45%" style="border:#999 1px solid"  height="25"><center>{$actojuridico->request.jueznotario|upper}</center></td>
            <td width="2%"><center>&nbsp;</center></td>
            <td width="28%" style="border:#999 1px solid"  height="25"><center>{$actojuridico->request.nombrejuzgado|upper}</center></td>
            <td width="2%"><center>&nbsp;</center></td>
            <td width="23%" style="border:#999 1px solid"  height="25"><center>{$actojuridico->request.lugarjuzgado|upper}</center></td>
          </tr>
          <tr>
  ...
  <tr>
    <td colspan="3" valign="top"><table width="100%" border="0">
      <tr>
        ...
        <td width="25%">EN LA QUE ORDENA LA INSCRIPCION DE REPOSICION DE MATRIMONIO DE:</td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3" valign="top">QUIENES CONTRAJERON MATRIMONIO</td>
  </tr>
  <tr>
    <td colspan="3" valign="top"><table width="100%" border="0">
      <tr>
        <td width="6%">A LAS</td>
        <td width="31%" style="border-bottom:#999999 1px solid;">{convertir_a_letras numero=$repomatrimonio->request.oficiofecha|date_format:"%I"}</td>
        <td width="6%">DE LA</td>
        <td width="29%" style="border-bottom:#999999 1px solid;">{if $repomatrimonio->request.oficiofecha|date_format:"%H">=12}TARDE{else}MA&Ntilde;ANA{/if}</td>
        <td width="7%">DEL DIA</td>
        <td width="21%" style="border-bottom:#999999 1px solid;">{convertir_a_letras numero=$repomatrimonio->request.oficiofecha|date_format:"%l"}</td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td colspan="3" valign="top"><table width="100%" border="0">
      <tr>
        <td width="11%">DEL MES DE</td>
        <td width="25%" style="border-bottom:#999999 1px solid;">{$repomatrimonio->request.oficiofecha|date_format:"%B"|upper}</td>
        <td width="9%">DEL AÑO</td><td width="27%" style="border-bottom:#999999 1px solid;"> {convertir_a_letras numero=$repomatrimonio->request.oficiofecha|date_format:"%Y"}</td>
        <td width="25%">EN LA QUE ORDENA LA INSCRIPCION DE REPOSICION DE MATRIMONIO DE:</td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td colspan="3" valign="top">ANTE LOS OFICIOS DE:</td>
  </tr>
  <tr>
    <td colspan="3" valign="top"><table width="100%" border="0">
      <tr>
        <td width="60%" style="border:#999999 1px solid;" height="25">{$repomatrimonio->request.oficiojueznotario|upper}</td>
        <td width="40%">&nbsp;</td>
      </tr>
      <tr>
