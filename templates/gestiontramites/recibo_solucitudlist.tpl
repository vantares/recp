<div id="listadoreco">
     ...
     <div class="filaencabezado">
           ...
           <div  class="filaencabezadoli primerafila" style="width:19%">Tipo de Inscripci&oacute;n</div> 
           <div  class="filaencabezadoli" style="width:40%; text-align:center">Tipo Tramite</div>
       ...
       {if $solicitudes}
           ...
           {assign var=solicitudcert value=$solicitudes[id]->getSolicitudInscripcion()}
            <div class="filadatos">
                ...
                <div class="filadatosli" style="width:40%; text-align:center">{$solicitudes[id]->request.tipotramite}</div>
