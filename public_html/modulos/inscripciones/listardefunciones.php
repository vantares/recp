...
if($usuario->checkCredenciales(array('Inscripciones'))) {  
    ...
    $inscripcionesbd = $inscripcion->readDataSQL("SELECT inscripcion.*,
                                              ...
                                              INNER JOIN tomo
                                                   ...
                                                   WHERE inscripcion.tipoinscripcion='Defunciones' ".
                                                         $filter.' ORDER BY acta.fecha DESC');
                                                         
    $cadena = new TCadena();    
    $smarty->assign('nombre',$_REQUEST['nombre']);  
    $smarty->assign('paginad','detallesdefuncion.php');
    $smarty->assign('pagina','editdefuncion.php');
    ...
    $smarty->assign('inscripcion','defuncion'); 
    ...
    $smarty->assign('urlnueva','/modulos/inscripciones/adddefuncion.php');
    $smarty->assign('template','inscripciones/listadoinscripciones.tpl'); 
    $smarty->assign('titular','Listado de Inscripciones de Defuncion'); 
    $smarty->assign('camino','Inscripcion >> Defuncion >> Listado'); 
