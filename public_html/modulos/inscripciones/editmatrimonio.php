...
if($usuario->checkCredenciales(array('Inscripciones'))) { 
    if(isset($_REQUEST['id']) && $_REQUEST['id'] > 0) {
        ...
        if((isset($_POST['salvar'])) && ($_POST['salvar'] == 'salvar')) {
            ...
            if(!$error) {
                ...
                if(!$error) { 
                    ...
                    if(!$error) {
                        ...
                        $_REQUEST['idmatrimonio'] = $actojuridico->request['idactojuridico'];
            ...
            $smarty->assign('notice',(!$error) ? 'La inscripcion fue actualizada correctamente desea volver a editar de click <a href="/modulos/inscripciones/editmatrimonio?id='.$inscripcion->request['idinscripcion'].'"><b>aqui</b></a>' : '<b>error:<b> La Inscripcion no se pudo crear');
        ...
        //Nacimiento conyuge1
	//TODO: corregir a cas el numero del tomo utilizar los datos provistos en el matrimonio para esto en lugar de buscar los datos de nacimeinto de los conyuges.
        ...
        if($nacimientoconyuge1) {
            ...
            $anyo1 = $fecha[0];
	    //echo "<!-- caso 1 "; print_r($actaConyuge1); echo " -->";
        } else {*/
	    ...
	    //echo "<!-- caso 2 "; print_r($actaConyuge1); echo " -->";
        ...
        if($nacimientoconyuge2) {
            ...
            $anyo2 = $fecha[0];
	    //echo "<!-- caso 1 "; print_r($actaConyuge2); echo " -->";
        } else { */
	    ...
	    //echo "<!-- caso 2 "; print_r($actaConyuge2); echo " -->";
        /* }         */
