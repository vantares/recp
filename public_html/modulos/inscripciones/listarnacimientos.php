...
if($usuario->checkCredenciales(array('Inscripciones'))) { 
    ...
    $filter = '';
    if($_REQUEST['nombre'] != '') $filter .= " AND (inscripcion.inscrito1nombre1 ILIKE '%".$_REQUEST['nombre']."%' OR inscripcion.inscrito1nombre2 ILIKE '%".$_REQUEST['nombre']."%')";
    ...
    $inscripcionesbd = $inscripcion->readDataSQL("SELECT inscripcion.*,
                                              ...
                                              INNER JOIN tomo
                                                   ...
                                                   WHERE inscripcion.tipoinscripcion='Nacimientos' ".
