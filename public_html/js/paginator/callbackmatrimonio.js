function pageselectCallback(page_index, jq,campos){
    ...
    if(arrayresult != '') {
        for(var i=page_index*opt[2];i<max_elem;i++) {
            ...
            newcontent += '<div class="filadatosli" style="width:7%; text-align:center"><span class="numeroverde"><b>' +segundoarreglo[camposarreglo[12]] + '</span></b></div>';
            newcontent += '<div class="filadatosli" style="width:37%; text-align:center">' + segundoarreglo[camposarreglo[3]] + segundoarreglo[camposarreglo[4]] + segundoarreglo[camposarreglo[5]] + segundoarreglo[camposarreglo[6]]+ '<br />' + segundoarreglo[camposarreglo[7]] + segundoarreglo[camposarreglo[8]] + segundoarreglo[camposarreglo[9]] + segundoarreglo[camposarreglo[10]] +'</div>';
            newcontent += '<div class="filadatosli" style="width:15%; text-align:center">' + segundoarreglo[camposarreglo[11]] + '</div>';           
